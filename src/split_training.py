...
def train_val_holdout_split_images(root_path, n_images = 350, train_ratio  = 0.7, validation_ratio = 0.2, holdout_ratio = 0.1, resize_size = (299,299)):
    """
...
train_val_holdout_split_images('data/')
